...
| A curated topic list: Awesome-GraphRAG | `https://github.com/DEEP-PolyU/Awesome-GraphRAG` | A second route of discovery, built on a different principle from the catalogue. The catalogue knows about a work what whoever uploaded it claimed, whereas inclusion in a list is the decision of a person who works in the subject. Only the identifiers of works are taken from the markup; what is known about them comes from the preprint archive, because a list is written by hand and its wording cannot be trusted. |
| A curated topic list: Graph-RAG survey list | `https://github.com/Graph-RAG/GraphRAG` | A second route of discovery, built on a different principle from the catalogue. The catalogue knows about a work what whoever uploaded it claimed, whereas inclusion in a list is the decision of a person who works in the subject. Only the identifiers of works are taken from the markup; what is known about them comes from the preprint archive, because a list is written by hand and its wording cannot be trusted. |
