...
export const DIMENSIONS: DimensionSpec[] = [
  ...
  { code: "A8", name: "Origin of index structure", stratum: "A", core: true, default: "none", values: ["none", "given", "extracted", "computed", "extracted_and_computed"] },
  { code: "B1", name: "Query transformation", stratum: "B", core: true, default: "identity", values: ["identity", "hyde", "multi_reformulation", "step_back", "subquestion_decomposition", "key_extraction"] },
